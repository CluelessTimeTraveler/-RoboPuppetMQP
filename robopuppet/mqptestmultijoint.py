...
class ExampleFullArmMovement:
    def __init__(self):
	    ...
	    rospy.Subscriber('/potAngles',JointPositions,self.example_send_joint_angles,queue_size=1)
    ...
    def example_send_joint_angles(self, angle_received):
        ...
        anglesArray = []
        anglesArray.append(angle_received.servoOne)
        anglesArray.append(angle_received.servoTwo)
        anglesArray.append(angle_received.servoThree)
        anglesArray.append(angle_received.encoderOne)
        ...
        for i in range(self.degrees_of_freedom):
            ...
            print(i)
            temp_angle.value = anglesArray[i]
